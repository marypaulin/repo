...
def bbound_nosimilar(x, y, lamb, prior_metric=None, MAXDEPTH=4, niter=float('Inf'), logon=False,
        ...
        for i in range(len(leaves)):
            ...
            for j in range(1, nrule + 1):
                ...
                if j not in d0 and -j not in d0:
                    ...
                    sorted_new_tree_rules = tuple(sorted([leaf.rules for leaf in unchanged_leaves]+[l1_sorted, l2_sorted]))
